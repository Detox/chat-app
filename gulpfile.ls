...
!function bundle-clean (done)
	del(['dist/style.css', 'dist/index.html', 'dist/script.js', 'sw.js']).then !->
		done()

!function bundle-css (done)
...
!function bundle-service-worker (done)
...
!function copy-favicon (done)
	fs.copyFileSync('favicon.ico', "dist/favicon.ico")
	done()

!function copy-js (done)
...
function generate-service-worker
...
function minify-service-worker
	gulp.src('sw.js')
		.pipe(uglify())
		.pipe(gulp-rename('sw.min.js'))
		.pipe(gulp.dest('.'))

!function update-index (done)
...
gulp
	..task('bundle-clean', bundle-clean)
	..task('bundle-css', bundle-css)
	..task('bundle-html', bundle-html)
	..task('bundle-js', bundle-js)
	..task('bundle-service-worker', bundle-service-worker)
	..task('clean', clean)
	..task('copy-audio', copy-audio)
	..task('copy-favicon', copy-favicon)
	..task('copy-js', copy-js)
	..task('copy-manifest', copy-manifest)
	..task('copy-wasm', copy-wasm)
	..task('generate-html', generate-html)
	..task('generate-service-worker', generate-service-worker)
	..task('minify-css', minify-css)
	..task('minify-font', minify-font)
	..task('minify-html', minify-html)
	..task('minify-js', minify-js)
	..task('minify-service-worker', minify-service-worker)
	..task('update-index', update-index)
	..task('main-build', gulp.series(
		'generate-html'
