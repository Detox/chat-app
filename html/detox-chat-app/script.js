    ...
    Polymer({
      ...
      _connect_to_the_network: function(){
        ...
        detoxChat.ready(function(){
          ...
          state = this$.state;
          core = detoxCore.Core(state.get_settings_bootstrap_nodes(), state.get_settings_ice_servers(), state.get_settings_packets_per_second(), state.get_settings_bucket_size(), state.get_settings_additional_options());
